...
function MovieManagement() {
  ...
  const handleDeleteMovie = async(id) => {
    const response= await axios.delete(
      `https://6627a8d5b625bf088c092ee9.mockapi.io/Movies/${id}`
    );
      ...
      render: (id) => (
        <>
          <Popconfirm
            ...
            description="mày có muốn xóa phim không?"
  ...
  async function fetchMovies() {
    const response = await axios.get(
      "https://6627a8d5b625bf088c092ee9.mockapi.io/Movies"
    );
  ...
  async function handleSubmit(values) {
    ...
    axios.post("https://6627a8d5b625bf088c092ee9.mockapi.io/Movies", values);
